project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: What's new in Chrome 59 for developers? Headless Chrome, Native Notifications on macOS and the Image Capture API.
