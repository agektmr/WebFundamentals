project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: You can easily change the DOM without having to edit the HTML as a giant string.
