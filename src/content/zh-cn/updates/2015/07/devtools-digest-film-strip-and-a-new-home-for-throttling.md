project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: Discover the new film strip functionality and more in this first of many DevTools Digest updates.
