project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: Perf tooling improvements in DevTools over the last few Chrome releases.

{# wf_updated_on: 2016-09-07 #} {# wf_published_on: 2016-09-07 #} {# wf_tags: devtools #} {# wf_featured_image: /web/updates/images/generic/chrome-devtools.png #}
...
*Available in Chrome 54, which is currently [Canary](https://www.google.com/chrome/browser/canary.html).*
...
* Ping us at [ChromeDevTools](https://twitter.com/chromedevtools) on Twitter for brief questions or feedback, or to share new ideas.
