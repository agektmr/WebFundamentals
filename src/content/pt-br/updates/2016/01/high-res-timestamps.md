project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: Find out when events occur with microsecond precision, thanks to DOMHighResTimeStamp.
