project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: New Console features, updates on the context selector bug, and the new UC Browser user agent.
