project_path: /web/_project.yaml book_path: /web/shows/_book.yaml description: Routing in Polymer, revealed! Get on the path to single page app goodness with this nugget of wisdom.
