project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: Re-order DevTools tabs which ever way suits you best and see exactly where framework events were bound.
