project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: In addition to copying the request/response headers of a network resource, you can also copy the response itself.﻿
