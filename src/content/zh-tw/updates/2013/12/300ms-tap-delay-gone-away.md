project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: Every click interaction in mobile browsers is hampered with a 300ms delay, but that's gone in Chrome 32 for mobile-optimized sites!

{# wf_updated_on: 2019-01-16 #} {# wf_published_on: 2013-12-12 #} {# wf_tags: news,mobile,performance,touchevent #} {# wf_blink_components: Mobile(Android),Mobile>WebView #}
