project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: Add service worker-powered offline capabilities to your site with the sw-precache module.
