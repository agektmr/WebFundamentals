project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: What's new in Chrome 61 for developers? JavaScript Modules, WebUSB, WebShare and more.
