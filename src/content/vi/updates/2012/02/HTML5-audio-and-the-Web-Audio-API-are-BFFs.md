...
{# wf_updated_on: 2019-02-01 #} {# wf_published_on: 2012-02-02 #} {# wf_tags: news,webaudio,multimedia,audio #} {# wf_blink_components: N/A #}
...
As noted in the code, there's [a bug](http://crbug.com/112368) that requires the source setup to happen after `window.onload`.
