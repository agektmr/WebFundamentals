project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: The DOM node context menu, which you may recognize from the elements panel, is also present in the console panel.
