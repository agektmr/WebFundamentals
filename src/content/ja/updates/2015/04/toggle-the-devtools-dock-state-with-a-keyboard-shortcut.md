project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: Use Cmd + Shift + D to toggle the DevTools dock state between the last two recently used states.
