project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: Learn how to get started building Progressive Web Apps

{# wf_updated_on: 2017-10-11 #} {# wf_published_on: 2015-12-15 #} {# wf_tags: progressive-web-apps,serviceworker #} {# wf_featured_image: /web/updates/images/2015/12/getting-started-pwa/pwa-general-0-@1x.jpg #}
...
![Web app install banners for engagement, launch from the user's home screen, splash screen in Chrome for Android, works offline with service worker](/web/updates/images/2015/12/getting-started-pwa/pwa-general-0-@1x.jpg)
...
![Progressive web apps working in Firefox for Android](/web/updates/images/2015/12/getting-started-pwa/pwa-general-ff-@1x.jpg)
...
![Progressive web apps working in Opera for Android](/web/updates/images/2015/12/getting-started-pwa/pwa-general-6-@1x.jpg)
...
![Add to home screen, launch from home screen and full-screen app-like experiences.](/web/updates/images/2015/12/getting-started-pwa/pwa-general-1-@1x.jpg)
...
![The voice memos demo application displaying a web app install banner prompt in Chrome for Android](/web/updates/images/2015/12/getting-started-pwa/pwa-general-2-@1x.jpg)
...
![Service worker caching of the application shell, allowing it to load without the network](/web/updates/images/2015/12/getting-started-pwa/pwa-general-3-@1x.jpg)
...
![The application shell being visualized as breaking down the UI of your app, such as the drawer and the main content area](/web/updates/images/2015/12/getting-started-pwa/pwa-application-shell.jpg)
...
![Polymer starter kit displaying progressive web app features built in](/web/updates/images/2015/12/getting-started-pwa/pwa-polymer-starter-kit-@1x.jpg)
...
![Progressive web apps implemented using React, Polymer, Virtual DOM and AngularJS](/web/updates/images/2015/12/getting-started-pwa/pwa-general-5-@1x.jpg)
