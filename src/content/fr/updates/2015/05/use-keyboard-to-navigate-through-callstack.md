project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: How to set a breakpoint and navigate through the call stack with keyboard shortcuts.
