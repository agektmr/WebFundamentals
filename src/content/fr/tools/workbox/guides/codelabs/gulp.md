project_path: /web/tools/workbox/_project.yaml book_path: /web/tools/workbox/_book.yaml description: Learn how to make a gulp-based app work offline by adding Workbox to it.
