project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: The Shape Detection API allows for faces, barcodes, and text to be detected in images.
