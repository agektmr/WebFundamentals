project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: Hardware video support brings efficient decoding to plugins as well as HTML5 video. Flash users should switch from the old style Video to the StageVideo object.

{# wf_updated_on: 2015-05-06 #} {# wf_published_on: 2015-05-06 #} {# wf_tags: news,video,flash,shaka-player,eme,mse,hardware-decoding,codecs #}
