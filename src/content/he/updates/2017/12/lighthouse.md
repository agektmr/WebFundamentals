project_path: /web/_project.yaml book_path: /web/updates/_book.yaml description: New performance audits, a rehaul of the accessibility score, report UX improvements, and bug fixes.
