project_path: /web/_project.yaml book_path: /web/shows/_book.yaml description: Making the most of media APIs across platforms, with an emphasis on practical advice for web devs.
